...
NSString * const kLastBuildDirectory = @"kLastBuildDirectory";
NSString * const kLastBuildName = @"kBuildName";
NSString * const kLastSourceName = @"kLastSourceName";
